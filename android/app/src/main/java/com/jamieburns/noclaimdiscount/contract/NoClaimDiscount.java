package com.jamieburns.noclaimdiscount.contract;
...
public final class NoClaimDiscount extends Contract {
    ...
    public static RemoteCall<NoClaimDiscount> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String _policyHolder, BigInteger _policyStart, BigInteger _policyEnd, BigInteger _accrualFequencyInSeconds, BigInteger _accrualFrom) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_policyHolder),
            new org.web3j.abi.datatypes.generated.Uint256(_policyStart),
            new org.web3j.abi.datatypes.generated.Uint256(_policyEnd),
            new org.web3j.abi.datatypes.generated.Uint256(_accrualFequencyInSeconds),
            new org.web3j.abi.datatypes.generated.Uint256(_accrualFrom)));
